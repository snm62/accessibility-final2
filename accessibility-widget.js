class AccessibilityWidget {
    ...
    applyBigBlackCursor() {
        // Apply cursor style to Shadow DOM
        if (this.shadowRoot) {
            this.shadowRoot.host.style.cursor = 'url(\'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64"><path d="M0,0 L16,16 L8,16 L12,28 L20,24 L16,12 L24,12 Z" fill="black" stroke="white" stroke-width="1"/></svg>\') 0 0, auto';
        }
    }
    ...
    resetBigBlackCursor() {
        // Reset cursor style on Shadow DOM
        if (this.shadowRoot) {
            console.log('Accessibility Widget: Resetting big black cursor on Shadow DOM');
            this.shadowRoot.host.style.cursor = 'auto';
        }
    }
    ...
    applyBigWhiteCursor() {
        // Apply cursor style to Shadow DOM
        if (this.shadowRoot) {
            this.shadowRoot.host.style.cursor = 'url(\'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64"><path d="M0,0 L16,16 L8,16 L12,28 L20,24 L16,12 L24,12 Z" fill="white" stroke="black" stroke-width="1"/></svg>\') 0 0, auto';
        }
    }
    ...
    resetBigWhiteCursor() {
        // Reset cursor style on Shadow DOM
        if (this.shadowRoot) {
            console.log('Accessibility Widget: Resetting big white cursor on Shadow DOM');
            this.shadowRoot.host.style.cursor = 'auto';
        }
    }
